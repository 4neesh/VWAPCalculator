...
public class VWAPCalculatorTest {
    ...
    public void testProcessPriceUpdate() {
        calculator.processPriceUpdate("AUD/USD", 0.75, 1000);
        calculator.processPriceUpdate("AUD/USD", 0.76, 2000);
        calculator.processPriceUpdate("AUD/USD", 0.77, 3000);
    ...
    public void testMultipleCurrencyPairs() {
        calculator.processPriceUpdate("AUD/USD", 0.75, 1000);
        calculator.processPriceUpdate("USD/JPY", 110.0, 2000);
        calculator.processPriceUpdate("AUD/USD", 0.76, 2000);
        calculator.processPriceUpdate("USD/JPY", 111.0, 3000);
        calculator.processPriceUpdate("NZD/GBP", 0.55, 1500);
        calculator.processPriceUpdate("NZD/GBP", 0.56, 2500);
